...
describe Printer do
  ...
  describe '#stringify_transactions' do
    it 'returns array with one credit string based on attributes of array of class obj passed in' do
      ...
      expect(subject.stringify_transactions([transaction_instance])).to eq ['24/02/2020 || 10.00 || || 10.00']
    end
    ...
    it 'returns array with 2 strings based on attrs of 2 objs of same type' do
      ...
      expect(subject.stringify_transactions([transaction_instance, transaction_instance_2])).to eq ['24/02/2020 || 10.00 || || 10.00', '24/02/2020 || 10.00 || || 10.00']
    end
